        ...
        <div className='about-left'>
            ...
            <div className='about-right'>
                ...
                <div>
                    ...
                    <p>Since our launch, we have been dedicated to curating a diverse selection of high-quality items to suit every style and need. From fashion and beauty to electronics and home essentials, we offer an extensive range of products sourced from reliable brands and suppliers.</p>
                    <b>Our Mission</b>
